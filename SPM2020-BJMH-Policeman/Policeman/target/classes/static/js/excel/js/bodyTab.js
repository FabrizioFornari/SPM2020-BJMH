...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="/home"><i class="layui-icon" data-icon=""></i><cite>Backend</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
