...
(function ($) {
    $.extend({
    	...
    	table: {
            ...
            init: function(options) {
                ...
                $('#' + options.id).bootstrapTable({
                    ...
                    onEditableSave: options.onEditableSave,             // 行内Edit保存的事件
        ...
        operate: {
            ...
            remove: function(id) {
            	table.set();
            	$.modal.confirm("确定Delete该条" + table.options.modalName + "信息吗？", function() {
            ...
            removeAll: function() {
        		...
        		$.modal.confirm("确认要Delete选中的" + rows.length + "条数据吗?", function() {
            ...
            successTabCallback: function(result) {
                if (result.code == web_status.SUCCESS) {
    	            ...
    	            $.modal.close();
    	            $.modal.msgSuccess(result.msg);
    	            $(".layui-layer-padding").removeAttr("style");
    	            if (table.options.type == table_type.bootstrapTable) {
    	        		$.table.refresh();
    	        	} else if (table.options.type == table_type.bootstrapTreeTable) {
    	        		$.treeTable.refresh();
